...
export const SnapshotView: React.FunctionComponent<{
  ...
  highlightedLocator: string,
  setHighlightedLocator: (locator: string) => void,
}> = ({ snapshotUrls, snapshotInfo, sdkLanguage, testIdAttributeName, isInspecting, setIsInspecting, highlightedLocator, setHighlightedLocator }) => {
