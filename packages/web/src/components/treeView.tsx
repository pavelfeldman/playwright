...
export function TreeItemHeader<T extends TreeItem>({
  ...
  return <div ref={itemRef} role='treeitem' aria-selected={item === selectedItem} aria-expanded={expanded} className='vbox' style={{ flex: 'none' }}>
    <div
    ...
    >
      ...
      />
      {icon && <div className={'codicon ' + (icon(item) || 'codicon-blank')} style={{ minWidth: 16, marginRight: 4 }} role='presentation'></div>}
