...
export class TestServerConnection implements TestServerInterface, TestServerInterfaceEvents {
  ...
  readonly onRecoverFromStepError: events.Event<{ message: string, location: reporterTypes.Location }>;
  ...
  private _onRecoverFromStepErrorEmitter = new events.EventEmitter<{ message: string, location: reporterTypes.Location }>();
