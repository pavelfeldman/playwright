...
function createLocator(injectedScript: InjectedScript, initial: string, options?: { withText?: string | RegExp }) {
  class Locator {
    selector: string;
    element: Element | undefined;
    elements: Element[];

    constructor(selector: string, options?: { withText?: string | RegExp }) {
    ...
    locator(selector: string, options?: { withText: string | RegExp }): Locator {
...
export class ConsoleAPI {
  ...
  constructor(injectedScript: InjectedScript) {
    ...
    window.playwright = {
      ...
      locator: (selector: string, options?: { withText?: string | RegExp }) => createLocator(this._injectedScript, selector, options),
