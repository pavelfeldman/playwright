...
it.only('checkboxes', async ({ page }) => {
  await page.setContent(`
    <input id='checkbox-1' type='checkbox' checked></input>
    <input id='checkbox-2' type='checkbox' checked></input>
  `);
  await expectCheckboxes(page, 3);
});
